 ...
 * DetailReservation
 *
 * @ORM\Table(name="detail_reservation", uniqueConstraints={@ORM\UniqueConstraint(name="idCli", columns={"idCli"})}, indexes={@ORM\Index(name="idH", columns={"idH"}), @ORM\Index(name="idV", columns={"idV"}), @ORM\Index(name="idT", columns={"idT"})})
 * @ORM\Entity
 */
